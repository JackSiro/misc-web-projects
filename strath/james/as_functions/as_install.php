...
<html>
	<head>
		...
		<style>
			body { font-family: arial,sans-serif; font-size:0px;margin: 50px 10px;	padding: 0; text-align: center;background: url(as_media/setup.jpg); color: darkblue; } h1{font-size:30px;} input[type="text"],input[type="email"],input[type="password"],textarea{font-size:20px;padding:5px;width:100%; color:darkblue; border:1px solid darkblue; border-radius: 0px; background: lightblue;} table{width:80%;margin:10px;} input[type="submit"]{background:#eee; color:darkblue; padding:10px 20px; border:1px solid darkblue; font-size:25px; border-radius: 0px; } img { border: 0; } .rounded {	-webkit-border-radius: 12px;	-moz-border-radius: 0px; border-radius: 0px;} .rounded_i {	-webkit-border-radius: 10px 10px 0px 0px;	-moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px;} .rounded_ii { background: #eee; border: 1px solid #eee; margin-top:10px; padding:20px; -webkit-border-radius: 0px 0px 10px 10px;	-moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px;} #content { margin: 0 auto;	width: 800px; } .top-section { background: #eee; border: 1px solid #eee; color: darkblue; font-weight: bold; padding: 12px ;}#debug { margin-top: 50px; text-align:left;	}.main-section { border: 1px solid #eee; margin: 5px;padding:10px; padding-bottom:10px; font-size:20px;} .mid-section { border: 1px solid #eee; margin-top: 10px; font-size:20px;}
		</style>
	</head>
	<body>
		<div id="content">
