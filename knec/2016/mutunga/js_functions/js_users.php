<?php
	function js_signin() {
		...
		$loginkey = md5($_POST['password']);
			...
			$_SESSION['mutunga_user'] = js_let_me_user($loginname, $loginkey);
			$_SESSION['mutunga_account'] = js_logged_account($loginname);
	...
	function js_is_logged(){
		$myloginid = isset( $_SESSION['mutunga_user'] ) ? $_SESSION['mutunga_user'] : "";
...
function logout() {
  unset( $_SESSION['mutunga_user'] );
  unset( $_SESSION['mutunga_account'] );
  header( "Location: index.php" );
}
