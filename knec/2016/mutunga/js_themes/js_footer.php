<footer>
	<a href=".">Home Page</a>
		...
		if ($myaccount){ echo
		'| <a href="index.php?action=item_all">Electronicss</a> 
  ...
  <script type="text/javascript" src="js_themes/js/tabs.js"></script>
  <script type="text/javascript" src="js_themes/js/tabs_old.js"></script>
