         ...
         <?php include JS_THEME."js_slide.php" ?>
          ...
          <br><hr><br>
			...
			if ($database->js_num_rows( $js_type_query)<=0) { ?>
				<h2 style="color:#000">You need to fix the following errors before you add a Electronics Item</h2>
				<ul>
				<h3><li><a href="index.php?action=type_new">No Type found! Add a Electronics Type</a></li><h3>
