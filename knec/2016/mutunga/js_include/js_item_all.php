	  ...
	  <div id="content"> 
        ...
        <div class="content_item">
         ...
         <?php include JS_THEME."js_slide.php" ?>
		  <h1><?php echo $database->js_num_rows( $js_db_query ) ?> Electronics Items
		  <a style="float:right;width:300px;text-align:center;" href="index.php?action=item_new">New Electronics Item</a> </h1> 
          <br><hr><br>
