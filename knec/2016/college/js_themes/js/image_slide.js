...
function slideShow(speed) {
  ...
  // append an 'li' student to the 'ul' list for displaying the caption
...
function gallery() {
  ...
  //if no images have the show department, grab the first image
  ...
  if(current.queue('fx').length == 0) {
    ...
    // set the fade in effect for the next image, show department has higher z-index
