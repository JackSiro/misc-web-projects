<?php include AS_THEME."as_header.php"; 
	...
	$as_db_query = "SELECT * FROM as_rating
					LEFT JOIN as_worker ON as_rating.rate_worker = as_worker.workerid
					ORDER BY as_rating.rate_worker  ASC LIMIT 20";
		...
		<div class="row box-5">
			...
			<div class="page_wrap">
		        ...
		        <tr onclick="location='index.php?action=worker_view&amp;as_workerid=<?php echo $row['workerid'] ?>'">
				  ...
				  <td><?php echo $row['worker_dept'] ?> <?php echo $row['worker_role'] ?></td>
				  <td><?php echo $row['rate_rating'] ?></td>
				  <td><?php echo $row['rate_comment'] ?></td>
		        </tr>
