<?php 
	...
	list( $itemid, $item_type, $item_quantity, $item_postedby, $item_posted, $item_apartment, $item_price, $item_unit, $item_img, $item_updated, $item_updatedby) = $database->get_row( $as_db_query );
}
...
<?php include AS_THEME."as_header.php"; ?>
			...
			<div class="main_content">
				...
				<h1>apartment: <?php echo as_type_item($item_type) ?></h1> 
          <br><hr>
				<table>
				<tr><td>
				...
				<h2>apartment: <?php echo as_apartment_item($item_apartment) ?></h2>
				...
				<div class="detail_info">
					<br><br>
					<h1>Place an tenant for this Item</h1> 
					  <br><hr><br>
					...
					<br>
                        <center>
						<input type="submit" class="submit_this" name="tenantNow" value="tenant this Item">
			  </center><br>
				</form>
				</div>
			</div>
