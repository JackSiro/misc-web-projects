<?php
	function as_signin() {
		...
		$loginkey = md5($_POST['password']);
			...
			$_SESSION['nafaka_user'] = as_let_me_user($loginname, $loginkey);
			$_SESSION['nafaka_account'] = as_logged_account($loginname);
	...
	function as_is_logged(){
		$myloginid = isset( $_SESSION['nafaka_user'] ) ? $_SESSION['nafaka_user'] : "";
...
function logout() {
  unset( $_SESSION['nafaka_user'] );
  unset( $_SESSION['nafaka_account'] );
  header( "Location: index.php" );
}
