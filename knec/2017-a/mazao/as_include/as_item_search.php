...
?>
	  <div id="content"> 
		...
		<br>
		  <h1><?php echo $database->as_num_rows( $as_db_query ) ?> Mazao Materials found
          ...
          <br><hr><br>
			...
			<?php $as_cat_qry = "SELECT * FROM as_type ORDER BY cat_title ASC";
			...
			<td><input type="submit" style="width:200px" name="SearchThis" value="Search" /></td></tr>
			   ...
			   <table class="tt_tb">
		        ...
		        <tr onclick="location='index.php?action=viewitem&amp;as_itemid=<?php echo $row['itemid'] ?>'">
				   <td><img class="iconic" src="as_media/<?php echo $row['item_img'] ?>" /></td>
				   <td><?php echo as_cat_item($row['item_cat']) ?></td>
