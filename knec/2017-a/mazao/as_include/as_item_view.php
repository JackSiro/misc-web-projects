<?php 
	...
	list( $itemid, $item_type, $item_quantity, $item_postedby, $item_posted, $item_supplier, $item_price, $item_unit, $item_img, $item_updated, $item_updatedby) = $database->get_row( $as_db_query );
}
	  ...
	  <div id="content"> 
		...
		<br>
			...
			<div class="main_content">
				...
				<h1>Cereal Item: <?php echo as_type_item($item_type) ?></h1> 
          <br><hr>
				<table>
				<tr><td>
				...
				<h2>Supplier: <?php echo as_supplier_item($item_supplier) ?></h2>
