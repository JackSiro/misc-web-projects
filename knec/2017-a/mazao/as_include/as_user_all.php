<?php include AS_THEME."as_header.php"; ?>
	<div id="site_content">	
	  ...
	  <div id="content"> 
		...
		<br>
		  <h1><?php echo $database->as_num_rows( $as_db_query ) ?> Mazao Users
		  <a style="float:right;width:300px;text-align:center;" href="index.php?action=newuser">Add New User</a> </h1> 
          <br><hr><br>
