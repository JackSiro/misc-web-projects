        ...
        <div>
		  <h1>Add a Student</h1>
			<div class="main_content">
				...
				<p style="padding-top: 15px"><span><input type="submit" id="submitBtn" name="AddStudent" value="Save & Add"></span><input type="submit" id="submitBtn" name="AddClose" value="Save & Close">
			  </p>		
			</form>
