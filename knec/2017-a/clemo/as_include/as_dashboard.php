			   ...
			   <table class="tb_dashboard">
				<tr>
				  <td class="td_dashboard td_one">
					<a href="index.php?action=class"><h1>Classes</h1></a>
					<?php if ($myaccount != "student") { ?><hr>
					<a href="index.php?action=class_new"><h2>Add a class</h2></a>
					<?php } ?>
				  </td>
				  <td class="td_dashboard td_two">
					<a href="index.php?action=student_all"><h1>Students</h1></a>
					<?php if ($myaccount != "student") { ?><hr>
					<a href="index.php?action=student_new"><h2>Add a Student</h2></a>
					<?php } ?>
				  </td>
				  <td class="td_dashboard td_two">
				...
				<tr>
				  <td class="td_dashboard td_three">
					<a href="index.php?action=teacher_all"><h1>Teachers</h1></a>
					<?php if ($myaccount != "student") { ?><hr>
					<a href="index.php?action=teacher_new"><h2>Add a teacher</h2></a>
					<?php } ?>
				  </td>
				  <td class="td_dashboard td_three">
