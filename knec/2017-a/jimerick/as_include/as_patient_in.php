<?php include AS_THEME."as_header.php"; 
	...
	$as_db_query = "SELECT * FROM as_patient patient_type='in-patient' ORDER BY patientid DESC LIMIT 20";
	$results = $database->get_results( $as_db_query );
?>
<div id="content">
		<div>
			<h1><?php echo $database->as_num_rows( $as_db_query ) ?> in-patients | <a href="index.php?action=patient_new">New patient</a></h1><br>
