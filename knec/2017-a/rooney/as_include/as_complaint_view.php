...
<?php include AS_THEME."as_header.php"; ?>
	<div id="site_content">	
	  ...
	  <div id="content"> 
		...
		<br>
		  <h1><?php echo $complaint_title ?> <a style="float:right" href="index.php?action=complaint_delete&&as_complaintid=<?php echo $complaintid ?>" onclick="return confirm('Are you sure you want to delete: <?php echo $complaint_title ?> from the system? \nBe careful, this action can not be reversed.')">Delete This Complaint</a></h1> 
          <div class="comp_content">
			 <p><?php echo $complaint_content ?><br>
			 Posted by: <?php echo as_complaint_client($client_fullname, $clientid) ?><br>
			Created: <?php echo as_timeago($complaint_created) ?>
			 </p><br>
