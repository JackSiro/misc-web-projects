...
?>
	<div id="content">
		  ...
		  <h2><?php echo $database->as_num_rows( $as_db_query ) ?> Materials found
		  <a class="button_small" style="float:right;width:300px;text-align:center;" href="index.php?action=newitem">Add New Material</a> </h2> 
          <br><hr><br>
