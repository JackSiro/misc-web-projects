<?php
	...
	include 'as_losts.php';
	include 'as_founds.php';
...
switch ( $action ) {
	...
	case 'rating_new':  rating_new();
		break;
	case 'lost_all': lost_all();
		break;
	case 'lost_new':  lost_new();
		break;
	case 'lost_view': lost_view();
		break;
	case 'lost_delete': lost_delete();
		break;
	case 'profile': 
	...
	case 'options':  as_options();
		break; 
	case 'found_new': found_new();
		break;	
	case 'found_all':  found_all();
		break;
	case 'found_view': found_view();
		break;		
    default:
		as_homepage();
}
