...
<div id="tooplate_main">
	<div class="col_w900 col_w900_last">
		  <h3>Pay Students Fee</h3>
			...
			<?php } else { ?>
			<form role="form" method="post" name="Fees" action="index.php?action=fee_new" >
				...
				<label for="text">Amount Paid:</label><input type="text" autocomplete="off" name="amount" required ></td>
				</tr>
				<div class="cleaner h10"></div>
