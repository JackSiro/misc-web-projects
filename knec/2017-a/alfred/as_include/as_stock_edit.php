        ...
        <div class="content_item">
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="SaveDrug" action="index.php?action=stock_edit&&as_stockid=<?php echo $stockid ?>" enctype="multipart/form-data" >
                ...
                <tr>
					...
					<td><input type="text" autocomplete="off" name="slogan" value="<?php echo $stock_quantity ?>" required ></td>
                        ...
                        <center><input type="submit" class="submit_this" name="SaveDrug" value="Save Changes">
