<?php
	...
	include 'as_visitors.php';
	include 'as_visits.php';
...
switch ( $action ) {
	...
	case 'rating_new':  rating_new();
		break;
	case 'visitor_all': visitor_all();
		break;
	case 'visitor_new':  visitor_new();
		break;
	case 'visitor_view': visitor_view();
		break;
	case 'visitor_delete': visitor_delete();
		break;
	case 'profile': 
	...
	case 'options':  as_options();
		break; 
	case 'visit_new': visit_new();
		break;	
	case 'visit_all':  visit_all();
		break;
	case 'visit_view': visit_view();
		break;		
    default:
		as_homepage();
}
