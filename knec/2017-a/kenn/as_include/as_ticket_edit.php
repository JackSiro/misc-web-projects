<?php 
	...
	list( $ticketid, $ticket_code, $ticket_cat, $ticket_slug, $ticket_title, $ticket_content, $ticket_postedby, $ticket_posted, $ticket_publisher, $ticket_subject, $ticket_img, $ticket_updated, $ticket_updatedby) = $database->get_row( $as_db_query );
}
          ...
          <br><hr><br>
			<div class="main_content">
				...
				<tr>
					...
					<td><select name="hotel" style="padding-left:20px;">
						<option value="<?php echo $ticketid ?>" > - Choose a Category - </option>
			<?php $as_db_query = "SELECT * FROM as_hotel ORDER BY cat_title ASC";
				$database = new As_Dbconn();			
				...
				<tr>
					...
					<td><input type="text" autocomplete="off" name="subject" value="<?php echo $ticket_subject ?>"></td>
                        ...
                        <input type="submit"class="mainBtn" id="submit" name="SaveItem" value="Save Changes">
						<input type="submit"  class="mainBtn" id="submit" name="SaveClose" value="Save & Close">
			  </form>
