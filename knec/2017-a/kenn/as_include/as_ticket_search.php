	  ...
	  <div id="content"> 
		...
		<br>
          ...
          <br><hr><br>
			...
			<?php $as_cat_qry = "SELECT * FROM as_hotel ORDER BY cat_title ASC";
			...
			<td><input type="submit" style="width:200px" name="SearchThis" value="Search" /></td></tr>
			   ...
			   <table class="tt_tb">
		        ...
		        <tr onclick="location='index.php?page=viewitem&amp;as_ticketid=<?php echo $row['ticketid'] ?>'">
				   <td><img class="iconic" src="as_media/<?php echo $row['ticket_img'] ?>" /></td>
				   <td><?php echo as_cat_item($row['ticket_cat']) ?></td>
