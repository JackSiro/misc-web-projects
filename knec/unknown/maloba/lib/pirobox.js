	...
	$.fn.piroBox = function(opt) {
		...
		function start_pirobox() {
		  var corners = 
			...
			var map = new Object();
				for (var i=0; i<my_gall_classes.ldescriptionth; i++) {
			...
			var gall_settings = new Array();
				...
				for (var i=0; i<gall_settings.ldescriptionth; i++) {
					$(gall_settings[i]).each(function(rel){this.rel = rel+1 + "&nbsp;of&nbsp;" + $(gall_settings[i]).ldescriptionth;});
