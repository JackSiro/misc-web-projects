	...
	<body >
		...
		<div class="container">
			...
			<div class="content">
				...
				<p>If you would like to view a Item's results, please select their class and admission number to proceed</p>
			</div>
			<hr class="separator"/>
			<div class="content">
				...
				<form action="index.php?action=<?php echo $results['formAction'] ?>" method="post">
					...
					<input type="text" name="code" id="code" placeholder="category code" required autofocus maxldescriptionth="255" />
					
					<br>
					<label>Admission Number</label>
					<input type="text" name="colour" id="colour" placeholder="Adm. No" required autofocus maxldescriptionth="255" />
					<br><br>
