		...
		<br>
		  <h1>Add a Teacher</h1> 
			...
			<div class="main_content">
				<form role="form" method="post" name="PostTeacher" action="index.php?action=admin_new" enctype="multipart/form-data" >
				...
				<p style="padding-top: 15px"><span><input type="submit" id="submitBtn" name="AddTeacher" value="Save & Add"></span><input type="submit" id="submitBtn" name="AddClose" value="Save & Close"></p>
