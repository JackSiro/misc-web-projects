	<div id="footer">
      <p><a href="index.html">Home</a> | <?php 
			if ($myaccount){ echo
			'<a href="index.php?action=student_all">Students</a> | <a href="index.php?action=class">Class</a> | <a href="index.php?action=settings">Settings</a> | <a href="index.php?action=logout">Logout?</a>'; 
